...
# 챔피언 추천 데이터 (한국어, 다양화)
champions_data = {
    "탑": ["다리우스", "가렌", "피오라", "카밀", "쉔", "말파이트", "초가스", "오른", "아트록스"],
    "정글": ["리 신", "카직스", "아무무", "이블린", "그라가스", "녹턴", "세주아니", "자르반 4세", "워윅"],
    "미드": ["아리", "르블랑", "제드", "카타리나", "오리아나", "야스오", "카시오페아", "신드라", "피즈"],
    "바텀": ["징크스", "이즈리얼", "카이사", "아펠리오스", "루시안", "바루스", "트리스타나", "케이틀린", "애쉬"],
    "서폿": ["쓰레쉬", "레오나", "나미", "브라움", "알리스타", "모르가나", "잔나", "소라카", "룰루"]
}
...
champion_comments = {
    ...
    "초가스": "라인 유지력 최고, 한타 탱킹도 튼튼 🐲",
    "오른": "딜+탱 조합, 라인 유지와 팀 공헌 동시에 ⚒️",
    "아트록스": "돌진하며 강력한 지속 딜 🔥",
    ...
    "녹턴": "궁극기로 갑작스러운 폭풍 등장 🌌",
    "세주아니": "강력한 군중 제어, 한타 선봉장 ❄️",
    "자르반 4세": "궁+이니시에이팅으로 한타 열기 ⚔️",
    "워윅": "라인 압박과 추격전 최강 🐺",
    ...
    "카시오페아": "지속 딜과 CC로 라인 지배 🐍",
    "신드라": "강력한 폭발 딜, 스킬콤보로 솔킬 💥",
    "피즈": "점멸+궁으로 적 뒤집기 🐟",
    "징크스": "폭발적인 딜, 카오스 플레이 💥",
    "이즈리얼": "스킬샷 잘 맞추면 캐리 가능 🎯",
    "카이사": "적응형 딜링, 유연한 플레이 😼",
    "아펠리오스": "복잡하지만 파괴력 최고 💀",
    "루시안": "순간 폭발 딜, 연속 스킬콤보 🔥",
    "바루스": "원거리 CC+딜, 한타 영향력 높음 🎯",
    "트리스타나": "라인 클리어와 폭발적인 딜 💣",
    "케이틀린": "긴 사거리로 안전하게 딜 📏",
    "애쉬": "궁으로 한타 개시, 팀 리딩 가능 🏹",
    "쓰레쉬": "훅+와딩으로 상대 괴롭힘 🪝",
    ...
    "알리스타": "돌진+스턴으로 한타 이끌기 🐂",
    "모르가나": "궁+CC로 핵심 적 묶기 🔗",
    "잔나": "강력한 회복과 바람궁으로 팀 지원 🌬️",
    "소라카": "힐러 전담, 팀 생존률 ↑ 💖",
    "룰루": "버프+CC로 아군 보호 및 재미 연출 🧚"
}

st.title("🎮 MBTI × 롤 챔피언 추천기 (한국어 + 다양한 챔피언)")
