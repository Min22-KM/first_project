...
MBTI_MAP = {
    "ISTJ": ("My Fair Lady, The Phantom of the Opera",
             "차분히 앉아 배우 디테일을 챙기는 타입. 줄거리·연출에 집중하며 박수 타이밍을 놓치지 않음 👌"),
    "ISFJ": ("The Sound of Music, The Lion King",
             "감성 충만 힐링 모드. 배우 표정에 공감하면서 살짝 눈물 글썽일 수 있음 😌💐"),
    "INFJ": ("Les Misérables, Dear Evan Hansen",
             "스토리와 메시지에 깊게 몰입. 공연 끝나고 생각 정리하느라 한동안 말수가 적어짐 🧠💭"),
    "INTJ": ("Hamilton, Sweeney Todd",
             "구조와 연출을 분석하는 관람자. 상징·연출 의도 찾다 ‘아하’하며 만족함 🕵️‍♂️📘"),
    "ISTP": ("Chicago, Kinky Boots",
             "현장 감각 중요시. 무대 기술·안무에 눈이 가고 웃음 포인트를 놓치지 않음 😎🎬"),
    "ISFP": ("Wicked, Moulin Rouge! (musical)",
             "비주얼과 음악에 취함. 영상미·무대미술에 감탄하며 사진 찍기 좋아함 🎨📸"),
    "INFP": ("Rent, Once",
             "감성 폭발형 관객. 노래 한소절에 울컥, 공연 끝나면 친구와 긴 대화 타임💬💕"),
    "INTP": ("The Curious Incident of the Dog in the Night-Time, Spring Awakening",
             "아이디어·설정에 호기심 폭발. 연출의 논리적 연결고리를 찾아 메모할 수도 📝🤓"),
    "ESTP": ("Grease, Rock of Ages",
             "현장 분위기 타며 신나게 즐기는 타입. 박수·리듬에 따라 몸이 먼저 반응함 🕺🔥"),
    "ESFP": ("Mamma Mia!, Cats",
             "연극 그 자체가 파티! 배우와 눈 마주치면 환호하고 웃음이 끊이지 않음 🥳🎉"),
    "ENFP": ("Hamilton, The Book of Mormon",
             "에너지 풀충전 관객. 아이디어가 번뜩여 공연 후 팬아트나 짤을 만들 확률 높음 ✨🖍️"),
    "ENTP": ("The Producers, Avenue Q",
             "비꼬는 유머·풍자를 즐김. 무대의 아이러니를 찾아 큰소리로 웃기도 함 😏🎭"),
    "ESTJ": ("West Side Story, Chicago",
             "정확한 타이밍과 질서에 민감. 관람 매너와 박수 타이밍을 어김없이 지킴 ✅👏"),
    "ESFJ": ("The Sound of Music, Dear Evan Hansen",
             "함께 보는 사람과의 공감형 관객. 배우 응원하며 티켓·굿즈 정보도 찰떡같이 챙김 💕🎫"),
    "ENFJ": ("Les Misérables, Hamilton",
             "배우의 메시지와 감정선에 몰입해 주변 사람들과 소감 공유하기 딱 좋음 🌟🤝"),
    "ENTJ": ("Sweeney Todd, Hamilton",
             "전략적으로 좋은 좌석·시간을 골라 관람. 공연의 큰 그림을 빨리 파악하고 평가함 🧭🏆"),
}
